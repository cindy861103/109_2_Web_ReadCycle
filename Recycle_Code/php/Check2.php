...
?>
	...
	<head>
		...
		<title>結帳2</title>
		<link rel="stylesheet" href="../css/Check2_style.css">
...
<body>
	...
	<div class="right">
		...
		<!-- 從結帳1取到$cart_all的資料-->
		<?php
		$cart_link = $_POST['cart_all']; //取自結帳1頁面上
		...
		<div class="left_container">
			...
			?>
				<form name="cart_detail" method="POST" action="Check3.php">
					<input type="hidden" name='cart_all' value='<?php echo $cart_link; ?>'>
					...
					<?php } ?>
					<div >
						<span><input id="sale-book_next" name='go_check3' value="下一步" type="submit"></span>
					</div>
				</form>
			<?php } ?>
		</div>
		...
		<div class="right_container">
			<p class="subtitle">買家聯絡資訊</p>
			<div class="buyer_info">
				<p class="name">買家姓名：<?php echo $attr['name']; ?></p>
				<p>手機：<?php echo $attr['phone_num']; ?></p>
				<p class="email">信箱：<?php echo $attr['email']; ?></p>
			</div>
			<p class="subtitle" align="center">總金額：<?php echo $total_price; ?> 元</p>
			<p class="note">*請確認聯絡資訊是否正確，否則交易無法順利進行</p>
		</div>
