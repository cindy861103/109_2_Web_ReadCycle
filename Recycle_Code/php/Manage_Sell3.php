...
<head>
    ...
    <link rel="stylesheet" href="../css/Manage_Sell3_style.css">
	<link rel="stylesheet" href="https://use.fontawesome.com/releases/v5.3.1/css/all.css" integrity="sha384-mzrmE5qonljUremFsqc01SB46JvROS7bZs3IO2EmfFsd15uHvIt+Y8vEf7N7fWAU" crossorigin="anonymous">
</head>
<?php
}else{
...
if($_SERVER["REQUEST_METHOD"]=="POST"){
        ...
        if ($db -> query($sql) === True){
            ...
            echo "<h2>編輯成功</h2>";
            header("Location:Manage_Sell2.php?member_id=$member_id&function_id=$function_id");
...
<body>
    ...
    <div class="bookinfo">
        <form method="post" action="Manage_Sell3.php">
            ...
            <p><select name="situation" name="Bookcondition" class="select_field" >
                ...
                <option value="拆封未使用">拆封未使用</option>
    ...
    <div>
        ...
        <button type="submit" class="confirm" href="Manage_Sell3.php">確認修改</button>
        
        <!-- 可能要調整位置 用br-->
        <button class="back" type="back" > 返回</button>
    </div>
