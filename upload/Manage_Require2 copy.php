...
if($_SERVER["REQUEST_METHOD"]=="POST"){
        ...
        if ($db -> query($sql) === True){
            echo "<h2>編輯成功</h2>";
            header("Location:Manage_Require2 copy.php?member_id=$member_id&function_id=$function_id");
        }else{
            echo "<h2>編輯失敗</h2>";
...
<body>
    ...
    <div class="bookinfo">
        <form method="post" action="Manage_Require2 copy.php">
    ...
    <div>
        ...
        <button type="submit" class="confirm" href="Manage_Require2 copy.php">確認修改</button>
        <!-- 用一個del.php  -->
        <a class="confirm" href="Manage_Require copy.php">刪除</a>
    </div>
    </form>
</body>
</html>